...
public final class R2Top3BestSaComparisonRun {
    ...
    public static void main(String[] args) {
        ...
        for (String instancePath : instancePaths) {
            ...
            runAlgorithm(instance, runs, "k8mixed3");
            runAlgorithm(instance, runs, "r2top3best5");
            runAlgorithm(instance, runs, "r2top3best10");
        }
    }
    ...
    private static OptimizationAlgorithm createAlgorithm(String algorithmKind, long seed) {
        ...
        if (algorithmKind.equals("r2top3best5")) {
            return randomized2RegretBestStartSa("ILS_R2REGRET_TOP3P20_BEST5_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 5, seed);
        }
        if (algorithmKind.equals("r2top3best10")) {
            return randomized2RegretBestStartSa("ILS_R2REGRET_TOP3P20_BEST10_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 10, seed);
        }
    ...
    private static OptimizationAlgorithm randomized2RegretBestStartSa(String name, int triesCount, long seed) {
        return constructionStartSa(
            name,
