...
/**
 * Dokładna wersja 2-regret aktualizująca top2 miejsc wstawienia po lokalnej zmianie cyklu.
 */
public final class FastTop2ExactTwoRegretCost implements OptimizationAlgorithm {
    private RunStats lastStats = new RunStats(0, 0, 0, 0, 0);

    @Override
    public String name() {
        return "FastTop2Exact2Regret";
    }
