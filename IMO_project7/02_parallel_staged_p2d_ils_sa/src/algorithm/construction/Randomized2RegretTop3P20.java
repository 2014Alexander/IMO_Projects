 ...
 * vertex. With probability 20% it chooses randomly from ranks 2-3 when such
 * candidates exist. The selected vertex is inserted into its best position.</p>
 */
public final class Randomized2RegretTop3P20 implements OptimizationAlgorithm {
    private static final double EXPLORATION_PROBABILITY = 0.20;
    private static final int MAX_EXPLORATION_RANK = 3;

    private final Random random;

    public Randomized2RegretTop3P20() {
        this(new Random());
    }

    public Randomized2RegretTop3P20(Random random) {
        this.random = Objects.requireNonNull(random, "random");
    }

    @Override
    public String name() {
        return "randomized_2regret_top3p20";
    }
