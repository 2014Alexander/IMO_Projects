 ...
 * </ol>
 */
public final class ConsensusR2Top3P30LSExtractAll10Top3 implements OptimizationAlgorithm {
    ...
    public ConsensusR2Top3P30LSExtractAll10Top3() {
        this(new Random());
    }

    public ConsensusR2Top3P30LSExtractAll10Top3(long seed) {
        this(new Random(seed));
    }

    public ConsensusR2Top3P30LSExtractAll10Top3(Random random) {
    ...
    @Override
    public String name() {
        return "ConsensusR2Top3P30_LSExtractAll10_Top3";
    }
    ...
    public Solution solve(Instance instance, int startVertexId) {
        ...
        for (int run = 0; run < BASE_RUNS; run++) {
            OptimizationAlgorithm construction = new Randomized2RegretParameterizedWithPhaseTwoDelete("R2_TOP3P30_CONSENSUS_try" + run, 3, 0.30, new Random(random.nextLong()));
