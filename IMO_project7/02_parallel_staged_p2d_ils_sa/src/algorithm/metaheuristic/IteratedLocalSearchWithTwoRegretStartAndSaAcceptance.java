...
/**
 * Wariant ILS z konstrukcyjnym startem 2-regret, druga faza usuwania i akceptacja SA.
 */
public final class IteratedLocalSearchWithTwoRegretStartAndSaAcceptance implements OptimizationAlgorithm, IterationCountingAlgorithm, SaAcceptanceStatistics {
    public static final double DEFAULT_INITIAL_TEMPERATURE = 300.0;
    public static final double DEFAULT_FINAL_TEMPERATURE = 10.0;
    ...
    public IteratedLocalSearchWithTwoRegretStartAndSaAcceptance(
        String name,
    ...
    public IteratedLocalSearchWithTwoRegretStartAndSaAcceptance(
        ...
        this(name, localSearch, perturbation, timeLimitNanos, seed, initialTemperature, finalTemperature, CoolingSchedule.GEOMETRIC);
    }
