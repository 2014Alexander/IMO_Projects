...
public final class LargeNeighborhoodSearchWithoutLocalSearch implements OptimizationAlgorithm, IterationCountingAlgorithm {
    ...
    public LargeNeighborhoodSearchWithoutLocalSearch(
        String name,
