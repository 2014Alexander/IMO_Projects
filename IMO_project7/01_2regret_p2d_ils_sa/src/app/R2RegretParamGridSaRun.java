...
public final class R2RegretParamGridSaRun {
    ...
    private static List<Variant> variants() {
        ...
        // Punkt 1: eksploracja P przy stalym TOP3 i BEST10.
        result.add(new Variant("ILS_R2REGRET_TOP3P10_BEST10_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.10, 10, false));
        result.add(new Variant("ILS_R2REGRET_TOP3P15_BEST10_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.15, 10, false));
        result.add(new Variant("ILS_R2REGRET_TOP3P20_BEST10_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.20, 10, false));
        result.add(new Variant("ILS_R2REGRET_TOP3P25_BEST10_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.25, 10, false));
        result.add(new Variant("ILS_R2REGRET_TOP3P30_BEST10_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.30, 10, false));

        // Punkt 2: liczba prob przy stalym TOP3P20.
        result.add(new Variant("ILS_R2REGRET_TOP3P20_BEST8_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.20, 8, false));
        result.add(new Variant("ILS_R2REGRET_TOP3P20_BEST12_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.20, 12, false));
        result.add(new Variant("ILS_R2REGRET_TOP3P20_BEST15_P2D_LS_START_SA_GEO_T0_300_TMIN_10", 3, 0.20, 15, false));
        return result;
    }
        ...
        for (int runIndex = 0; runIndex < runs.size(); runIndex++) {
            ...
            System.out.println(
                instance.name + "," + algorithm.name() + "," + runIndex + ","
                    ...
                    + variant.topK() + "," + variant.probability() + "," + variant.triesCount() + ","
                    + COOLING + "," + T0 + "," + TMIN
            );
            System.out.flush();
        }
