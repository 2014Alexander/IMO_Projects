...
/** Runs vertex reseed count variants around CHEAP_CONSENSUS_FAST_R2_TOP3P30 baseline. */
public final class VertexReseedCountTestsRun {
    ...
    private static List<Variant> variants() {
        ...
        variants.add(new Variant("ILS_CHEAP_CONSENSUS_FAST_R2_TOP3P30_LSTOP5_OR_BEST_PARENT_DYNAMIC_FIXED", 0));
        variants.add(new Variant("ILS_CHEAP_CONSENSUS_FAST_R2_TOP3P30_VERTEX_RESEED_TOP2_LSTOP5_OR_BEST_PARENT_DYNAMIC_FIXED", 2));
        variants.add(new Variant("ILS_CHEAP_CONSENSUS_FAST_R2_TOP3P30_VERTEX_RESEED_TOP3_LSTOP5_OR_BEST_PARENT_DYNAMIC_FIXED", 3));
        variants.add(new Variant("ILS_CHEAP_CONSENSUS_FAST_R2_TOP3P30_VERTEX_RESEED_TOP4_LSTOP5_OR_BEST_PARENT_DYNAMIC_FIXED", 4));
        variants.add(new Variant("ILS_CHEAP_CONSENSUS_FAST_R2_TOP3P30_VERTEX_RESEED_TOP5_LSTOP5_OR_BEST_PARENT_DYNAMIC_FIXED", 5));
        return variants;
    }
