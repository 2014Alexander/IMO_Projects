...
public final class ConsensusDynamicBackboneSingleVariantRun {
    ...
    public static void main(String[] args) {
        ...
        String[] instancePaths = args.length >= 4 ? instancePaths(args) : new String[] {"data/TSPA.csv", "data/TSPB.csv"};
        ...
        for (String instancePath : instancePaths) {
            ...
            for (int runIndex = 0; runIndex < runs.size(); runIndex++) {
                ...
                OptimizationAlgorithm algorithm = createAlgorithm(kind, name, run.runSeed());
    ...
    private static String name(Kind kind) {
        return switch (kind) {
            ...
            case CHEAP_CONSENSUS_R2 -> "ILS_CHEAP_CONSENSUS_R2_TOP3P30_P2DALL10_LSTOP5_TOP3_START_SA_GEO_T0_300_TMIN_10";
            case CONSENSUS_R2_DYNAMIC_BACKBONE -> "ILS_CONSENSUS_R2_TOP3P30_DYNAMIC_ELITE_BACKBONE_OBJECTIVE_SA_GEO_T0_300_TMIN_10";
            case CHEAP_CONSENSUS_R2_DYNAMIC_BACKBONE -> "ILS_CHEAP_CONSENSUS_R2_TOP3P30_DYNAMIC_ELITE_BACKBONE_OBJECTIVE_SA_GEO_T0_300_TMIN_10";
        };
    }
    ...
    private static OptimizationAlgorithm createAlgorithm(Kind kind, String name, long seed) {
        ...
        if (kind == Kind.CONSENSUS_R2_DYNAMIC_BACKBONE
                || kind == Kind.CHEAP_CONSENSUS_R2_DYNAMIC_BACKBONE) {
            return new IteratedLocalSearchWithDynamicEliteBackboneSaAcceptance(
                    name,
                    createStartAlgorithm(kind, name, seed),
                    new SteepestLocalSearchWithCandidateMoves(),
                    TIME_LIMIT_NANOS,
                    seed,
                    T0,
