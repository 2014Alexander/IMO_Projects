...
public final class R2RegretUniversalTuningFastRun {
    private static final long TIME_LIMIT_NANOS = 500_000_000L;
    private static final int DEFAULT_RUNS_COUNT = 5;
    ...
    private static List<Variant> variants() {
        return List.of(
            new Variant("ILS_2REGRET_P2D_START_SA_GEO_T0_300_TMIN_10_SWAP30", 30, 300.0, 10.0, true),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_300_TMIN_10_SWAP25", 25, 300.0, 10.0, false),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_300_TMIN_10_SWAP30", 30, 300.0, 10.0, false),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_300_TMIN_10_SWAP35", 35, 300.0, 10.0, false),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_200_TMIN_10_SWAP30", 30, 200.0, 10.0, false),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_500_TMIN_10_SWAP30", 30, 500.0, 10.0, false),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_300_TMIN_5_SWAP30", 30, 300.0, 5.0, false),
            new Variant("ILS_R2REGRET_TOP3P30_BEST12_P2D_LS_START_SA_GEO_T0_300_TMIN_20_SWAP30", 30, 300.0, 20.0, false)
        );
    }
    ...
    private static OptimizationAlgorithm createAlgorithm(Variant variant, long seed) {
        if (variant.baseline()) {
            return new IteratedLocalSearchWithTwoRegretStartAndSaAcceptance(
                variant.name(), new SteepestLocalSearchWithCandidateMoves(), new RandomSwapEdgesPerturbation(variant.swapEdges()), TIME_LIMIT_NANOS, seed, variant.t0(), variant.tmin(), COOLING);
        }
        return new IteratedLocalSearchWithConstructionStartAndSaAcceptance(
            variant.name(),
            new Randomized2RegretParamBestNWithPhaseTwoDeleteStart(variant.name() + "_START", TOP_K, RANDOM_PROBABILITY, TRIES_COUNT, seed, new SteepestLocalSearchWithCandidateMoves()),
            new SteepestLocalSearchWithCandidateMoves(), new RandomSwapEdgesPerturbation(variant.swapEdges()), TIME_LIMIT_NANOS, seed, variant.t0(), variant.tmin(), COOLING
        );
    }
